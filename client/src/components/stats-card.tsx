interface StatsCardProps {
  ...
  value: string | number;
  subValue?: string;
  icon: "fire" | "book" | "bookmark" | "calendar";
}

export default function StatsCard({ title, value, subValue, icon }: StatsCardProps) {
  const renderIcon = () => {
    switch (icon) {
      case "fire":
        return (
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm">
      ...
      {subValue && <p className="text-sm text-neutral-600 mt-1">{subValue}</p>}
    </div>
  );
}
